...
canvas.addEventListener("mousedown", function (e) {
  ...
  let y = e.clientY - 100;  // why -100 [Refer Notion Notes]
  ctx.beginPath();  // used to start a line path. Jab tak ye dobara se nhi likha jaayega tab tak nyi line start nhi hogi
  ctx.moveTo(x, y);  // ye line ka beginig point hota hai [Refer Notion Notes]
...
/*
#1. undo functionality - Check Video
#2. redo functionality - Check Video
*/